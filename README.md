# prazer, ferreiraluizga :)

**`Desenvolvedor Full-Stack`**

Olá! Me chamo Gabriel e sou desenvolvedor de sistemas full-stack, com ênfase em Java e Spring Boot. Tenho experiência em criação de APIs Rest, desenvolvimento multiplataforma com banco de dados integrado, e gerenciamento de sistemas web em PHP. Sou apaixonado por engenharia de software e por música, e nas horas vagas, toco vários instrumentos e sou compositor. Além disso, sou cristão e Jesus é meu maior amor e fonte de prazer: tudo que eu faço é por Ele e para Ele. Aqui você encontrará os meus projetos e uma forma de como a tecnologia pode melhorar nossas vidas e o Reino de Deus :)
